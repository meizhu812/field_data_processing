...
import pandas as pd
# Parameters ###########################################################################################################
DATA_PATH = r'd:\Truman\Desktop\present_work\01_ammonia\01_data\01_2016summer\02_concentration\02_high8m\00_raw'
TEMP_DIR = r'd:\Temp\PICARRO_2016SH'
FREQ = '15T'
PICARRO = dict(sep='\s+',
               usecols=[0, 1, 17, 21],
               parse_dates=[[0, 1]])
