...
"""
import pandas as pd
EDDY_PATH = r'd:\Desktop\present_work\01_ammonia\01_data\03_2018summer\02South\01Meteorology\02_eddy\output'
# noinspection SpellCheckingInspection
INPUT_NAME = r'\eddypro_03_full_output_2018-12-12T144821_exp.csv'
# noinspection SpellCheckingInspection
...
out_cols = ['wd(deg)', 'U(m/s)', 'Sgm_v', 'u*(m/s)',  'L(m)', 'H(J/m2)', 'rho(kg/m3)', 'key(1/0==use ustar & Obu_L /use H_sensible heat)']
flux_out.columns = out_cols
flux_out.to_csv(EDDY_PATH+OUTPUT_NAME, date_format='%y%m%d%H%M', index_label='Datetime', sep=' ', float_format='%.3f')
